<%-- 
    Document   : list-test
    Created on : Aug 3, 2020, 3:31:32 PM
    Author     : Huy
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <a href="<c:url value="/test/createTestForm"/>" class="btn btn-success waves-effect">Create test</a>
                            </div>
                            <div class="body table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach var="test" items="${tests}">
                                            <c:url var="updateLink" value="/test/updateTestForm">
                                                <c:param name="testId" value="${test.test_id}" />
                                            </c:url>
                                            
                                            <c:url var="deleteLink" value="/test/deleteTest">
                                                <c:param name="testId" value="${test.test_id}" />
                                            </c:url>
                                        ...
                                        <tr>
                                            ...
                                            <td>${test.test_type.test_type_name}</td>
                                            <td>
                                                <a href="${deleteLink}" class="btn btn-danger btn-delete" onclick="if (!(confirm('Are you sure you want to delete this test?'))) return false"><i class="material-icons">delete</i></a>
                                ...
                                <center>
									...
									<c:url value="/test/list" var="prev">
									...
									<c:url value="/test/list" var="next">
										<c:param name="page" value="${page + 1}" />
									</c:url>
